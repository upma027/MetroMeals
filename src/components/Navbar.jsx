...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand" to="/">
      <img src={logo} alt="MetroMeals Logo" className="logo-img" />
    </Link>
    ...
    <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
      <ul className="navbar-nav me-auto">
        <li className="nav-item">
          <Link className="nav-link  fs-5 mt-3 btn btn-secondary" aria-current="page" style={{color:"White"}} to="/">Home</Link>
        </li>
        {localStorage.getItem("authToken")?
        <li className="nav-item">
          <Link className="nav-link fs-5 mt-3 btn btn-secondary ms-3 " style={{color:"White"}} to="/myOrder">My Orders</Link>
        </li>
        :""}
